...
class WriterTools:
    ...
    @classmethod
    def export_to_pdf(
        cls, output_path=None, output_filename=None, include_comments=False, quality="standard"
    ):
        """
    ...
    def set_paragraph_alignment(cls, alignment, paragraph_indices=None):
        ...
        try:
            ...
            if alignment.lower() not in alignment_map:
                cls.ret = (
                    f"Error: Invalid alignment '{alignment}'. Use 'left', 'center', 'right', or 'justify'."
                )
                return cls.ret
        ...
        try:
            ...
            for idx in valid_indices:
                ...
                capitalized_text = " ".join(
                    word.capitalize() if word else "" for word in text_content.split(" ")
                )
    ...
    def set_default_font(cls, font_name, font_size=None):
        ...
        try:
            ...
            cls.ret = f"Default font set to '{font_name}'" + (
